...
namespace MadbullAPI
{
    public class Startup
    {
        ...
        {
            services.Configure<MadbullDatabaseSettings>(
                Configuration.GetSection(nameof(MadbullDatabaseSettings)));

            services.AddSingleton<IMadbullDatabaseSettings>(sp =>
